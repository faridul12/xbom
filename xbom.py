...
def update():
    try:
        ...
        toolVersion = "XAKILXK1L"
    
    try:
        mainVersion = requests.get("https://github.com/faridul12/xbom.git").text
    except:
    ...
    os.system("cd .. && rm -rf xbom && git clone https://github.com/faridul12/xbom.git")
...
def logo():
    ...
    print("\033[94m│     \033[92m|-   -|    -|_| |_|  |__\033[94m   │".center(columns+15))
    print("\033[94m│     \033[92m|__|__|__|__|_____|_____|\033[94m   │".center(columns+15))
    print("\033[94m│     \033[92m                                                                             \033[94m   │".center(columns+15))
    print("\033[94m│                              \033[94m          │".center(columns+9))
    print("\033[94m│ \033[95mAuthor : XAKIL XK1L                    \033[94m│".center(columns+15))
    print("│ \033[95mTool   : Unlimited SMS Bomber          \033[94m│".center(columns+9))
    print("│ \033[95mGitHub : https://github.com/XK1L71I \033[94m│".center(columns+9))
    print("│ \033[95mCoder  : XAKIL XK1L71              \033[37mV3.0 \033[94m│".center(columns+15))
    print("\033[94m└────────────────────────────────────────┘".center(columns+5))
